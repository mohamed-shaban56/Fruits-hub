...
class HaveAnAccount extends StatefulWidget {
  const HaveAnAccount({super.key, this.onTap});
final Function()? onTap;

  @override
  State<HaveAnAccount> createState() => _HaveAnAccountState();
}


class _HaveAnAccountState extends State<HaveAnAccount> {
  late TapGestureRecognizer tapRecognizer;
  @override
  void initState() {
    super.initState();
    tapRecognizer=TapGestureRecognizer()..onTap=widget.onTap;
  }
  @override
  void dispose() {
    super.dispose();
