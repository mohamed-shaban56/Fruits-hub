...
void handleShippingNavigationLogic(OrderInputEntity orderEntity, BuildContext context,int index,PageController controller) {
     if(orderEntity.isPayWithCash !=null)
    {
          
      controller.animateToPage(index,duration: Duration(milliseconds: 200), curve: Curves.bounceIn);
    }else{
      userMessege(context: context, errorMessege: S.current.choose_payment_method_first);
    }
  }