...
void paypalProcessPayment({required BuildContext context,required OrderInputEntity orderEntity})
{
...
PaypalEntity paypalEntity=PaypalEntity.fromEntity(orderEntity,'USD');
  ...
  Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) => PaypalCheckoutView(
                  sandboxMode: true,
                  clientId: ApiKeys.paypalPublicKey,
                 ...
                 paypalEntity.toJson()
                  ...
                  onSuccess: (Map params) async {
                    ...
                    await addOrderRefrence.addOrder(orderEntity);
